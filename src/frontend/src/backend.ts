...
export class Backend implements backendInterface {
    ...
    async createThread(arg0: string, arg1: string): Promise<ThreadId> {
        if (this.processError) {
            try {
    ...
    async getPendingConnectionRequests(): Promise<Array<ConnectionRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPendingConnectionRequests();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getThread(arg0: ThreadId): Promise<ConnectionsThread> {
        if (this.processError) {
            try {
    ...
    async getThreadReplies(arg0: ThreadId): Promise<Array<ConnectionsReply>> {
        if (this.processError) {
            try {
                const result = await this.actor.getThreadReplies(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUserConnections(arg0: Principal): Promise<Array<Principal>> {
        if (this.processError) {
            try {
    ...
    async listThreads(arg0: bigint, arg1: bigint): Promise<Array<ConnectionsThread>> {
        if (this.processError) {
            try {
